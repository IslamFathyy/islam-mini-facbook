    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                Users u = await _userManager.FindByEmailAsync(Input.Email);
                if (u != null)
                {
                    if (u.Isblocked == true)
                    {
                    ...
                    {
                        var result = await _signInManager.PasswordSignInAsync(u.UserName, Input.Password, Input.RememberMe, lockoutOnFailure: false);
                        if (result.Succeeded)
                        {
